...
const LessonsController = { index, trash, destroy, deleteMethod, restore, forceDelete, toggleStatus, toggleFree, manageVocabularies, addVocabularies, removeVocabulary, importVocabularies, create, store, show, edit, update, delete: deleteMethod }
