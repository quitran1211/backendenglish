...
/**
* @see \App\Http\Controllers\Admin\VocabularyController::importExcel
 * @see app/Http/Controllers/Admin/VocabularyController.php:42
 * @route '/admin/vocabularies/importExcel'
 */
export const importExcel = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
 ...
 * @route '/admin/vocabularies/importExcel'
 */
importExcel.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: importExcel.url(options),
    method: 'get',
})
/**
 ...
 * @route '/admin/vocabularies/importExcel'
 */
importExcel.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: importExcel.url(options),
    method: 'head',
})
 ...
 * @route '/admin/vocabularies/importExcel'
 */
    const importExcelForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/admin/vocabularies/importExcel'
 */
        importExcelForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: importExcel.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/admin/vocabularies/importExcel'
 */
        importExcelForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: importExcel.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
