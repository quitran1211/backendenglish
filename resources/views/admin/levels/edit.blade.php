...
@section('title', 'Chỉnh sửa Cấp độ')
    ...
    <div class="container-fluid p-4">
        ...
        <div class="d-flex align-items-center justify-content-between rounded border bg-white p-4 shadow-sm mb-4">
            <h2 class="h4 fw-semibold mb-0 text-dark">
                <i class="fa-solid fa-pen-to-square text-warning"></i> Chỉnh sửa Cấp độ
            </h2>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="level_code"
                            ...
                            value="{{ old('level_code', $level->level_code) }}" placeholder="VD: A1, B2, C1..." required
                            maxlength="50">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="level_name"
                            ...
                            value="{{ old('level_name', $level->level_name) }}" placeholder="VD: Beginner, Intermediate..."
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="target_score"
                            ...
                            value="{{ old('target_score', $level->target_score) }}" placeholder="VD: 400, 550..." required
                            maxlength="255">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="total_words"
                            ...
                            value="{{ old('total_words', $level->total_words) }}" min="0">
                        @error('total_words')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="display_order"
                            ...
                            value="{{ old('display_order', $level->display_order) }}" min="0">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="color" name="color"
                                ...
                                value="{{ old('color', $level->color ?? '#007bff') }}" title="Chọn màu sắc">
                            <input type="text" class="form-control"
                                value="{{ old('color', $level->color ?? '#007bff') }}" id="colorValue" readonly>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="description" rows="4" class="form-control @error('description') is-invalid @enderror"
                            placeholder="Nhập mô tả chi tiết về cấp độ này...">{{ old('description', $level->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
