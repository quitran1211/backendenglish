        ...
        <div class="row mb-4">
            ...
            <div class="col-md-2">
                <div class="card bg-primary text-white">
                    <div class="card-body">
                        <h5 class="card-title">Tổng DT</h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($transaction->proof_image)
                                            ...
                                            <!-- Modal xem ảnh -->
                                            <div class="modal fade" id="proofModal{{ $transaction->id }}"
                                                tabindex="-1">
                                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">
                                                                Chứng từ - {{ $transaction->transaction_code }}
                                                            </h5>
                                                            <button type="button" class="btn-close"
                                                                data-bs-dismiss="modal"></button>
                                                        </div>
                                                        <div class="modal-body text-center">
                                                            <img src="{{ route('transactions.proof.image', $transaction->id) }}"
                                                                alt="Chứng từ thanh toán" class="img-fluid rounded"
                                                            ...
                                                            <div class="mt-3">
                                                                <small class="text-muted">
                                                                    ...
                                                                    Upload lúc:
                                                                    {{ $transaction->proof_uploaded_at ? $transaction->proof_uploaded_at->format('d/m/Y H:i') : 'N/A' }}
                                                                </small>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer justify-content-between">
                                                            <div class="d-flex gap-2">
                                                                <a href="{{ route('transactions.proof.image', $transaction->id) }}"
                                                                ...
                                                                @if ($transaction->status === 'pending')
                                                                    <form
                                                                        ...
                                                                        <button type="submit"
                                                                            ...
                                                                            onclick="return confirm('Xác nhận thanh toán cho giao dịch này?')">
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm gap-2">
                                            <a href="{{ route('transactions.show', $transaction) }}"
                                                class="btn btn-info rounded d-flex align-items-center justify-content-center"
                                                style="width: 36px; height: 36px;" title="Chi tiết">
                                            ...
                                            <form action="{{ route('transactions.destroy', $transaction) }}"
                                                ...
                                                <button type="submit"
                                                    ...
                                                    style="width: 36px; height: 36px;" title="Xóa"
